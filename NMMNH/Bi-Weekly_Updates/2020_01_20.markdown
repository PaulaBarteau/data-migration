...
### Lindsey
**Complete**
 - Finished bulkloading Herbarium specimens. 
 - Received, unpacked and tested more digitization equipment
 - Met with digitization crew to get started with SPNHC abstracts and travel

**In Process**
 - Working on standardizing Herbarium data to be uploaded to GBIF
 - Working on fixing dates and agents in arthropod data.
 - Mentoring Paula on taxonomy procedures for the mollusc bulkload
