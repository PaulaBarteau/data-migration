 ...
 **In Process**
 - Fossil preparation loans
 - Reviewing taxon and part data as requested
 - Part issues on Github
...
- need a way for Hannah to access photography equipment and type specimens
- keep macro lens in Bio so Paula can use it too

- add time in Share TODAY
